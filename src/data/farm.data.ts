...
export const FARM_CROPS: FarmCropDef[] = [
  {
    id: 'crop_corn', name: 'Corn', seedPriceCents: 1_400, growMs: 70_000, witherMs: 900_000,
    harvestYield: 8, storageUnitsPerItem: 1, basePriceCents: 310, color: '#f0c94c',
  },
  {
    id: 'crop_wheat', name: 'Wheat', seedPriceCents: 1_000, growMs: 55_000, witherMs: 900_000,
    harvestYield: 7, storageUnitsPerItem: 1, basePriceCents: 240, color: '#d8b85b',
  },
  {
    id: 'crop_soybean', name: 'Soybeans', seedPriceCents: 1_700, growMs: 85_000, witherMs: 900_000,
    harvestYield: 9, storageUnitsPerItem: 1, basePriceCents: 350, color: '#8db45b',
  },
  {
    id: 'crop_potato', name: 'Potatoes', seedPriceCents: 1_900, witherMs: 900_000, growMs: 75_000,
