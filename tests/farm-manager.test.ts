...
describe('Farm Manager V1', () => {
  ...
  it('migrates v18 closed and normalizes corrupt manager state closed', () => {
    ...
    expect(SAVE_VERSION).toBe(25); expect(farmOf(migrated).workforce.manager).toEqual({ hired: false, enabled: false, parcelId: 'starter', cropId: 'crop_corn', lastReviewedDay: 0 });
